...
The second task required rendering the MEI file into verovio which can be viewed [here](https://ranabrewer.github.io/MCA-2022/verovio.html) and a screenshot of the verovio rendering can also be seen below.
